...
class DiscreteDistribution(dict):
    ...
    def normalize(self):
        ...
        for key in self.keys():
            self[key] = float(self[key])/total_sum
...
class ExactInference(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        for previousPosition in self.beliefs:
            newDistribution = self.getPositionDistribution(gameState, previousPosition)
            for nextPosition in newDistribution:
                newBeliefs[nextPosition] += newDistribution[nextPosition] * self.beliefs[previousPosition]
